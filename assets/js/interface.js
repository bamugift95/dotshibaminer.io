// var minersAddr = '0xDb7095353ba2eF1B329930f1fb69E209492e3467';
// var tokenAddr = '0xf8483B65313833B402036eF7889741304314c2CB';

var minersAddr = '0x4F62E87dCa829BE83088c5EaA748ff6482863AC6';
var tokenAddr = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
var minersAbi = [
	{
		"constant": true,
		"inputs": [],
...
function buyEggs(ref, trx, callback) {
    if (+trx > +usrBal) {
        alert("You don't have " + trx + " DOTSHIBA in your wallet");
    } else if (+trx > +spend) {
        alert("Approve spending " + trx + " DOTSHIBA first");
    } else {
